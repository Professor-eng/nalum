...
const AdminSidebar = () => {
  ...
  return (
    <div className="w-64 bg-slate-50 text-gray-900 h-screen flex flex-col fixed left-0 top-0 border-r border-gray-200 transition-all duration-300">
      {/* Logo/Brand */}
      <div className="p-6 border-b border-gray-200 flex-shrink-0 transition-colors duration-300">
        <h1 className="text-2xl font-bold text-gray-900 transition-colors duration-300">Nalum Admin</h1>
        <p className="text-sm font-medium text-gray-800 mt-1.5 transition-colors duration-300">{user?.name}</p>
        <p className="text-xs text-gray-500 mt-0.5 transition-colors duration-300">{user?.email}</p>
      ...
      {/* Logout */}
      <div className="p-4 border-t border-gray-200 flex-shrink-0 transition-colors duration-300">
        <button
